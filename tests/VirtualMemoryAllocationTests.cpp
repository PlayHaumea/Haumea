...
extern "C" bool StingerFixUnalignedFault(void*) {
	return false;
}
...
uint64_t UnalignedAccessCount(uint32_t) {
	return 0;
}

uint64_t GuestFaultCount(uint32_t) {
	return 0;
}
}
...
int main(int argc, char** argv) {
	...
	if (argc == 2 && std::strcmp(argv[1], "--direct-partial-unmap-only") == 0) {
